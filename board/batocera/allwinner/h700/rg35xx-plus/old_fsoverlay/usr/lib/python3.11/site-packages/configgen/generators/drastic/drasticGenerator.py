...
def configurePads(settings, system, drastic_conf):
    ...
    "controls_a[CONTROL_INDEX_TOUCH_CURSOR_UP]              = 105        # PAD2KEY MOUSE   \n",
    "controls_a[CONTROL_INDEX_TOUCH_CURSOR_DOWN]            = 107        # PAD2KEY MOUSE   \n",
    "controls_a[CONTROL_INDEX_TOUCH_CURSOR_LEFT]            = 106        # PAD2KEY MOUSE   \n",
    "controls_a[CONTROL_INDEX_TOUCH_CURSOR_RIGHT]           = 108        # PAD2KEY MOUSE   \n",
    "controls_a[CONTROL_INDEX_TOUCH_CURSOR_PRESS]           = 110          # Left Click      \n",
    "controls_a[CONTROL_INDEX_MENU]                         = 109          # F1              \n",
    ...
    "controls_a[CONTROL_INDEX_UI_UP]                       = 338          # I               \n",  #Let Drastic Choose Default
    "controls_a[CONTROL_INDEX_UI_DOWN]                     = 337          # K               \n",  #Let Drastic Choose Default
    "controls_a[CONTROL_INDEX_UI_LEFT]                     = 336          # J               \n",  #Let Drastic Choose Default
    "controls_a[CONTROL_INDEX_UI_RIGHT]                    = 335          # L               \n",  #Let Drastic Choose Default
    "controls_a[CONTROL_INDEX_UI_SELECT]                   = 65535           # Return          \n",  #Let Drastic Choose Default
    "controls_a[CONTROL_INDEX_UI_BACK]                     = 65535           # BackSpace       \n",  #Let Drastic Choose Default
    "controls_a[CONTROL_INDEX_UI_EXIT]                     = 65535           # Escape          \n",  #Let Drastic Choose Default
    ...
    "controls_b[CONTROL_INDEX_UI_EXIT] = 1028           \n",
    "controls_b[CONTROL_INDEX_UI_PAGE_UP] = 1031     \n",
    "controls_b[CONTROL_INDEX_UI_PAGE_DOWN] = 1032\n",
    "controls_b[CONTROL_INDEX_UI_SWITCH] = 1033"))
